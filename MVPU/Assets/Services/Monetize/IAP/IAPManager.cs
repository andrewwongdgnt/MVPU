...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string ALL_OF_THE_ABOVE = "all_of_the_above";
    ...
    public void InitializePurchasing()
    {
       ...
       // builder.AddProduct(Something, ProductType.Consumable);
        ...
        builder.AddProduct(ALL_OF_THE_ABOVE, ProductType.NonConsumable);
    ...
    {
        return BuyProductID(NO_ADS);
    }
    public bool BuyUnlockAllLevels()
    {
        return BuyProductID(UNLOCK_ALL_LEVELS);
    }
    public bool BuyAllOfTheAbove()
    {
        return BuyProductID(ALL_OF_THE_ABOVE);
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, NO_ADS, StringComparison.Ordinal)
            || String.Equals(args.purchasedProduct.definition.id, UNLOCK_ALL_LEVELS, StringComparison.Ordinal)
